...
Double-click the <img style="width:100px" src="../_static/media/chapter_10/section_1/image2.png"  /> on desktop. 
...
<td style="text-align: center;"><p>Insert a action before the selected action.</p>
<p> </p></td>
</tr>
<tr>
...
<img class="common_img" src="../_static/media/chapter_10/section_2/image8.png"  alt="loading"  style="width: 60%; margin: 0 auto 24px; display: block;"/>
...
<span id="_2.2.1 Execute single action" class="anchor"></span>
...
(1) According to the operation steps in"5.[2.2 Call Action Group\Execute Single Action](#anchor_2_2_2_1)", enter the following command  to enter program file and editing mode.
...
(4) Now, modify the parameter in function with the name of action group to be performed. Then, save and exit. Finally, enter command “python3 control_demo.py” .
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image5.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image8.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image11.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;"/>
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image14.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image16.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image19.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image22.png"  alt="loading"  style="width: 60%; margin: 0 auto 24px; display: block;"/>
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image25.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image27.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/image32.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
(5) Then click “Integrate action file” again and double click to open “wave_pro.d6a”. We can find that action group file has been integrated.
...
<img class="common_img" src="../_static/media/chapter_10/section_4/image7.png"  alt="loading" style="width: 60%; margin: 0 auto 24px; display: block;" />
...
<img class="common_img" src="../_static/media/chapter_10/section_5/image11.png"  alt="loading"  style="width: 60%; margin: 0 auto 24px; display: block;"/>

<img class="common_img" src="../_static/media/chapter_10/section_5/image1.0.png"  alt="loading"  style="width: 60%; margin: 0 auto 24px; display: block;"/>
